...
Source0  : https://files.pythonhosted.org/packages/0c/e3/58911b7b523b10d3cdc1bebfe08ad66347c81e9bf2e2d8d9074031b1ef40/natsort-8.3.0.tar.gz
...
%prep
%setup -q -n natsort-8.3.0
cd %{_builddir}/natsort-8.3.0
pushd ..
cp -a natsort-8.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677546265
