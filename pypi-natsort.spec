...
%prep
%setup -q -n natsort-8.2.0
cd %{_builddir}/natsort-8.2.0
pushd ..
cp -a natsort-8.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672291662
...
cp %{_builddir}/natsort-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-natsort/ec36ce814d9e7dfa1aed23f6318dca5a9e94cc21 || :
