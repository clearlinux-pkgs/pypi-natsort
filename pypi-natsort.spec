...
Source0  : https://files.pythonhosted.org/packages/e2/a9/a0c57aee75f77794adaf35322f8b6404cbd0f89ad45c87197a937764b7d0/natsort-8.4.0.tar.gz
...
%prep
%setup -q -n natsort-8.4.0
cd %{_builddir}/natsort-8.4.0
pushd ..
cp -a natsort-8.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687273640
...
cp %{_builddir}/natsort-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-natsort/0c7a5145bb5a04addb5503d441f6e6a05e44e47c || :
...
/usr/share/package-licenses/pypi-natsort/0c7a5145bb5a04addb5503d441f6e6a05e44e47c
