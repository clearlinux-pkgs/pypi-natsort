...
Source0  : https://files.pythonhosted.org/packages/47/2a/bf13bfc1a51b6df2f823909c6d4f674a256e3f29401825e1d56ca2a95dc9/natsort-8.3.1.tar.gz
...
%prep
%setup -q -n natsort-8.3.1
cd %{_builddir}/natsort-8.3.1
pushd ..
cp -a natsort-8.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677775989
